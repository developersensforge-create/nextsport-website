  ...
  return (
    <>
      ...
      <main className="pt-20">
        ...
        {/* Hero */}
        <section className="bg-[#0A1628] min-h-[70vh] flex items-center py-24">
          <div className="max-w-6xl mx-auto px-6 text-center">
            <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-6">
              Get NextSport<br /><span className="text-[#00E676]">Free on Any Device</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <a
                href="#"
                className="flex items-center justify-center gap-3 bg-white text-[#0A1628] font-semibold px-8 py-4 rounded-xl hover:bg-gray-100 transition-colors text-base"
              >
              ...
              <a
                href="#"
                className="flex items-center justify-center gap-3 bg-[#00E676] text-[#0A1628] font-semibold px-8 py-4 rounded-xl hover:bg-[#00ff88] transition-colors text-base"
              >
                <svg viewBox="0 0 24 24" className="w-7 h-7" fill="currentColor">
        ...
        <section className="bg-[#F8FAFC] py-24">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl font-bold text-[#0A1628] text-center mb-16">What You&apos;ll Get</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={item.title} className="text-center">
                  {/* Phone placeholder */}
                  <div className="w-48 h-80 bg-gradient-to-br from-[#0A1628] to-[#0d2040] rounded-[32px] border-2 border-[#00E676]/20 mx-auto mb-6 flex flex-col items-center justify-center gap-4 shadow-xl">
                    <div className="text-5xl">{item.icon}</div>
                    <p className="text-white/40 text-xs text-center px-4">App screenshot coming soon</p>
                  </div>
        ...
        <section className="bg-white py-20">
          <div className="max-w-2xl mx-auto px-6 text-center">
            <h2 className="text-2xl font-bold text-[#0A1628] mb-4">Scan to Download</h2>
