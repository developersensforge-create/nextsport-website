        ...
        <section className="bg-[#0A1628] min-h-[70vh] flex items-center py-24">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <a
                href="#"
                className="flex items-center justify-center gap-3 bg-[#26a65c] text-[#0A1628] font-semibold px-8 py-4 rounded-xl hover:bg-[#1e8f4e] transition-colors text-base"
              >
                <svg viewBox="0 0 24 24" className="w-7 h-7" fill="currentColor">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={item.title} className="text-center">
                  <div className="w-48 rounded-[32px] border-2 border-[#26a65c]/20 mx-auto mb-6 overflow-hidden shadow-xl bg-[#0A1628]">
                    <Image
