      ...
      <main className="pt-20">
        ...
        <section className="bg-[#1a4d2e] min-h-[70vh] flex items-center py-24">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            {/* App Store Buttons — coming soon, not clickable */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <span className="flex items-center justify-center gap-3 bg-white/30 text-white/50 font-semibold px-8 py-4 rounded-xl cursor-not-allowed select-none text-base">
              ...
              <span className="flex items-center justify-center gap-3 bg-[#f0cc3c]/30 text-white/50 font-semibold px-8 py-4 rounded-xl cursor-not-allowed select-none text-base">
                <svg viewBox="0 0 24 24" className="w-7 h-7" fill="currentColor">
